        ...
        <div className="row justify-content-center min-vh-100 align-items-center">
          <div className="col-lg-4 text-center">
            <h3 className="text-color-light">
              Nos enfocamos en prestar el mejor servicio de préstamos en línea en
              <mark className="text-color-light bg-transparent p-0 mark mark-gradient mark-gradient-primary">
                finanzasypréstamos.com
              </mark>
            </h3>
